        ...
        <div class="sidebar-wrapper active">
            ...
            <div class="sidebar-menu">
                <ul class="menu">
                    ...
                    <router-link to="/products" v-slot="{ href,navigate, isActive, isExactActive }" custom>
                    ...
                    <router-link to="/categories" v-slot="{ href,navigate, isActive, isExactActive }" custom>
                        <li class="sidebar-item" :class="[isActive && 'active', isExactActive && '']">
                        <a :href="href" @click="navigate" class='sidebar-link'>
